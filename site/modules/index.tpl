...
<html lang="en">
    ...
    <body class="home page-template-default page page-id-9 page-home" >
        ...
        <div class="wrapper">
            ...
            <div class="wrapper__inner" style="margin:70px 0px 0px 0px;">

                <video data-automation="HomepageHero_heroVideo_video" loop="" muted="" autoplay="" class="l_P_e">
                    <source src="https://airholo.ru/video/v.webm" type="video/webm"/>
                    <source src="https://airholo.ru/video/v.mp4" type="video/mp4"/>
                </video>
                ...
                <div class="hypervsn" id="hypervsn">
                    <div class="hypervsn__inner">
                        ...
                        <div class="hypervsn__text">
                            ...
                            <div class="_desc">
                                Hypervsn™ это передовое решение для создания 3D-голографических анимаций в воздухе. 
                ...
                <div class="simple" id="how-it-works">
                    <div class="container">
                        <div class="simple__title">
                            <h2>Просто. Интуитивно. Красиво. </h2>
                        </div>

                        <div class="simple__desc">
                            На протяжении многих лет в эволюции Hypervsn ™ мы создали продукт, позволяющий перевернуть представления в мире маркетинга и рекламы. Теперь фантазия не ограничена плоскостью. Вы можете увлекать сознание людей в собственный мир, наполненный новой, почти осязаемой реальностью.</br>
                ...
                <div class="fit" id="industry">
                    ...
                    <div class="container">
                        <div class="fit__title">
                            ...
                            <p>
                                Работая на собственной облачной платформе, Hypervsn™ от Kino-mo вышла далеко за пределы понятия "просто клёвая штучка". Это комплексное решение которое может быть легко интегрировано в ваш бизнес, предоставляя полную систему медиапланирования и помогая вам превзойти отраслевую конкуренцию. 
                    ...
                    <div class="years__inner">
                        ...
                        <div class="years__item">
                            ...
                            <ul class="_list">
                                ...
                                <li>
                                    Получены соответствующие разрешения и сертификаты
                                </li>
                ...
                <div class="footer__main">
                    <div class="_col">
                        <div class="footer__info">
                            ...
                            <div class="_item">
                                <a href="#" class="footer__email footer__action"><span class="__cf_email__">info@airholo.ru</span></a>
                            </div>
        ...
        <script type="text/javascript" >
            (function (d, w, c) {
                (w[c] = w[c] || []).push(function() {
                    try {
                        w.yaCounter48837650 = new Ya.Metrika({
                            id:48837650,
                            clickmap:true,
                            trackLinks:true,
        ...
        <noscript><div><img src="https://mc.yandex.ru/watch/48837650" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
        <!-- /Yandex.Metrika counter -->
